...
Describe how measurements are obtained
...
Bootloader: preparing image for OTA update, preparing bootloader for OTA update, updating
without cutting power? Updating safety critical systems?

Prototype with certificates instead of PSK, tokens, and COSE signing instead of
encryption.

...
workflow of communicating an update. Section~\ref{sec:upgrading} discusses different means
...
devices are in the maintenance stage of the lifecycle, and re-enrollment and updating
...
Figure~\ref{fig:operator-proxy} shows an operator sending updates entirely through an

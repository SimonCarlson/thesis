...
updates might communicate with servers or operators outside the constrained network. If the
...
verifying the token. If the verification process is complex and the device very
...
\begin{figure}
    \caption{A light bulb vendor technician updates a light bulb controller in a smart home,

...
% TODO: Mention that SUIT does not provide a format specification, only elements that
% should be included
% Point out mandatory vs optional, argue for putting optional elements in options
% structure as in CoAp because of 1) smaller baseline manifest size 2) flexibility to add
% new elements 3) enable custom manifest elements for niche deployments 4) less to
% implement, simpler parser
% Show holistic image of manifest building blocks and how they relate
% Show packet format with byte sizes

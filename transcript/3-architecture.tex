...
implementing the manifest as the packet structure must be prepared for it. This is
discussed in Section~\ref{sec:manifest-implementation}. % TODO: Reference section where
% manifest implementation is shown

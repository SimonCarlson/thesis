...
% Dedicate this to transportation CoAP -> DTLS -> UDP
% Also format of manifest
% Encoding? CBOR?

\chapter{Updating of Firmware Images}
% Dedicate this to local upgrading of images Storage locations, bootloader, how firmware
% updates differs from software updates

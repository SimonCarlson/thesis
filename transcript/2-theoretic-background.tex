...
layer in IoT networks. Subsection \ref{ssec:udp} explains UDP and why UDP is preferable in
...
% Table with manifest elements, their status, brief notes
\begin{longtable}[]{@{}lll@{}}
...
modifies it slightly to work over CoAP, DTLS, and UDP instead of HTTP, TLS, and TCP.

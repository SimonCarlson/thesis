...
\subsection{OSCORE}
\label{ssec:oscore}
% TODO: Very brief intro to OSCORE
...
instance by making use of CoAP's block requests and responses to remedy the relatively
...
protected resources through authorization tokens. 

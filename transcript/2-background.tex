...
transporting firmware images as well as meta-data needed to securely update an IoT system.
...
\subsection{Firefly}
\label{ssec:firefly}
% TODO: Move to experimental setup
...
ARM Cortex-M3 with 512 KB flash and 32 KB RAM. Furthermore the board supports IEEE
802.15.4 communication in the 2.4 GHz band and SHA2 hardware acceleration
\parencite{firefly-datasheet}.

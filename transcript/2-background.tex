...
constrained networks and is thus incompatible with the SUIT specification, which is specified
...
\begin{description}
    ...
    \item [Use state-of-the-art security mechanisms:]
            the SUIT specification assumes a \gls{pki} is in place. The PKI will allow for

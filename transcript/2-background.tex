...
The SUIT specification for providing updates, which is agnostic of any specific
technology, was also introduced. This standard can be expanded and profiled in order to
propose a possible solution. The thesis develops a prototype of such a solution using the
Contiki-NG operating system. The next chapter expands upon the works of SUIT discussing
topics such as roles, authorization, and communication of updates, apply a life cycle view
to IoT updates, and define profiles for implementing an update architecture.

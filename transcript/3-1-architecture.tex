...
between the author of an update and an operator, the proposed architecture does for
...
\begin{figure}[t]
    \caption[An operating system vendor technician updates patient wearable in an elderly home.]
        {An operating system vendor technician updates patient wearable in an elderly home. The figure assumes the device is enrolled and registered.}
...
\begin{figure}[t]
    ...
    home.]
        {A light bulb vendor technician updates a light bulb controller in a smart
